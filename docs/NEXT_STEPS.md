...
1. Publier strictement en fast-forward `9879cae` et ce checkpoint documentaire sur `codex/tradikom-one-os`, sans inclure `tmp/`.
2. Attendre la CI autoritative : migrations PostgreSQL, `db:verify`, sauvegarde/restauration, preuves RLS avec rôles restreints, suite exhaustive, build et Playwright. Corriger tout échec réel avant de revendiquer la tranche comme prouvée CI.
