...
3. Partir du head aad9261; la CI PostgreSQL/Playwright 31525021392 et la continuité 31525021312 sont vertes.
...
- CI PostgreSQL/Playwright du head `aad9261` entièrement verte : 118 fichiers/488 tests et 20/20 Playwright;
