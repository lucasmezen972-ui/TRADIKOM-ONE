...
- Le head local et distant de reprise est `c08be1b357e6ec9ecbcb96cacc98df2dacc34081`. La PR #11 est ouverte, brouillon et `MERGEABLE/CLEAN`.
- La CI `33402359544` et la continuité `33402359545` sont entièrement vertes sur `c08be1b`, y compris migrations PostgreSQL, backup/restauration, RLS, lint, typecheck, tests, build et Playwright.
...
5. La réconciliation est publiée par 64192145; le head de reprise c08be1b est synchronisé et sa CI 33402359544 ainsi que sa continuité 33402359545 sont entièrement vertes.
