...
3. Partir du head cca7e2a; la CI PostgreSQL/Playwright 31290349598 et la continuité 31290349595 sont vertes.
...
- CI PostgreSQL/Playwright du head `cca7e2a` entièrement verte : 118 fichiers/488 tests et 20/20 Playwright;
