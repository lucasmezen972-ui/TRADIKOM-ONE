...
1. Continue workflow engine depth: additional domain-specific async handlers beyond lead, connector sync, and Radar sync, plus deeper recovery views beyond the current dead-letter requeue control.
