...
1. Continue workflow engine depth: persisted execution attempts, richer retry/backoff metadata, domain-specific async handlers beyond the lead workflow, and manual recovery controls for failed domain events.
