...
1. Continue workflow engine depth: add more domain-specific async handlers beyond lead, connector sync, and Radar sync, plus recovery actions beyond the current queue overview and dead-letter requeue control.
