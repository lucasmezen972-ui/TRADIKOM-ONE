...
1. Continue workflow engine depth: richer retry/backoff metadata, domain-specific async handlers beyond the lead workflow, and deeper recovery views beyond the current dead-letter requeue control.
