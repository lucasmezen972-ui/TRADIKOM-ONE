...
- Full service modularization is in progress; the legacy `src/lib/services.ts` remains the central adapter for websites, public lead ingestion, CRM, connectors, dashboards, and tenant default provisioning.
