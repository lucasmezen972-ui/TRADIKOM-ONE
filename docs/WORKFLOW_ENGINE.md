...
`call_webhook` cree un evenement `workflow.webhook_requested` idempotent. Le worker effectue un POST HTTPS avec retry/backoff, timeout, refus des redirections et des cibles locales/privees, limites de charge utile et audit de succes.
