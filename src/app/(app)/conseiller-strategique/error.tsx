...
export default function StrategicAdvisorErrorPage({
  reset,
}: {
  ...
  return (
    <div className="rounded-lg border border-rose-200 bg-white p-6 shadow-sm">
      <h1 className="text-2xl font-bold">Conseiller indisponible</h1>
      <p className="mt-2 text-slate-600">
        Les recommandations ne peuvent pas être chargées pour le moment.
      </p>
      <button
        type="button"
        onClick={reset}
